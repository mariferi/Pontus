...
public static void viewReport(String customerID) throws IOException {
    ...
    File file = new File("W:\\SFM\\Pontus\\pontus\\src\\main\\java\\sfm\\pontus\\report.txt");
    ...
    public static void addStaff(String username, String password){
        ...
        //App.executeQueryforUpdate("INSERT INTO staff (userName, password) VALUES ('"+username+"', '"+password+"')");

    }

    public static void removeStaffFromDB(Staff staff){
    int id = staff.id;
    //App.executeQueryforUpdate(" DELETE FROM staff WHERE id="+id);

}
/*
    public static ObservableList<Staff> getStaffListFromDB(){
         ObservableList<Staff> staffList = FXCollections.observableArrayList();
        ResultSet rs = App.executeQueryforRS("SELECT * FROM staff");
        Statement st;
